...
const Home = (props) => {
    ...
    const panelText = (
        <Fragment>
            ...
            <p>Have been working as a commercial front-end developer for just shy of a decade, consistently expanding knowledge into full-stack domains, particular involving the MERN stack</p>
